...
describe("HomePage", () => {
  ...
  describe("should be able to add token", () => {
    it("white", () => {
      element
        .query(
          By.css("#white-tokens ion-row ion-col:nth-child(3) ion-fab-button"),
        )
    ...
    it("black", () => {
      element
        .query(
          By.css("#black-tokens ion-row ion-col:nth-child(3) ion-fab-button"),
        )
        .triggerEventHandler("click", null);
  ...
  describe("should be able to decrease token ", () => {
    it("white", () => {
      ...
      element
        .query(
          By.css("#white-tokens ion-row ion-col:nth-child(1) ion-fab-button"),
        )
        .triggerEventHandler("click", null);
    ...
    it("black", () => {
      ...
      element
        .query(
          By.css("#black-tokens ion-row ion-col:nth-child(1) ion-fab-button"),
        )
        .triggerEventHandler("click", null);
